        ...
        <section id="faq-section" className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div id="faq-header" className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-gray-900 mb-6">FAQ &amp; AI Myth Busters</h2>
                ...
                {/* <!-- Bias Section --> */}
                <div id="bias-section" className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 mb-16 text-white">
                    <div className="flex items-start gap-4">
