  ...
  return (
    <section id="stats" className="py-20 bg-[#1f2937] text-white">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-3xl lg:text-4xl font-bold text-center mb-4">The Future is Now</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center p-6 rounded-xl bg-gradient-to-br from-green-600/20 to-emerald-600/20 border border-green-600/30">
            <div className="text-3xl lg:text-4xl font-bold text-green-400 mb-2">$15.7T</div>
          ...
          <div className="text-center p-6 rounded-xl bg-gradient-to-br from-orange-600/20 to-red-600/20 border border-orange-600/30">
            <div className="text-3xl lg:text-4xl font-bold text-orange-400 mb-2">1 in 4</div>
          ...
          <div className="text-center p-6 rounded-xl bg-gradient-to-br from-pink-600/20 to-[#6f6f7d]/20 border border-pink-600/30">
            <div className="text-3xl lg:text-4xl font-bold text-pink-400 mb-2">90%</div>
